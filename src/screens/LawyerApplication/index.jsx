...
const LawyerApplication = () => {
  ...
  const renderButton = () => {
    if (formStep > 2) {
      ...
      return <ContinueButton onPress={handleSubmit(submitForm)} disabled={!isValid} />;
    } else {
    ...
    <View style={tw`bg-gray-200 h-full`}>
      ...
      <View>
        ...
        {formStep === 3 && (
          ...
          >
            <Text style={tw`text-xl font-semibold`}>Application Submitted</Text>
            <Text style={tw`mx-2 text-lg text-black`}>
              Hello, thank you for submitting the application form. Our Review
              Team will review your application and would contact you.
            </Text>
          </View>
        )}
      </View>
